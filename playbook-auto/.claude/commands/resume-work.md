...
- If unsure what to work on: "Run `/autopilot` to start or continue the autonomous build"
- If milestone complete: "Milestone done! Run `/autopilot` to continue the autonomous build"
...
- `/autopilot` — Continue the autonomous build
